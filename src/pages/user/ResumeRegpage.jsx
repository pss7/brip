            ...
            <div className="lnbLayoutBox">
              ...
              <div className={`content ${style.content} flexColumn`}>
                ...
                <ResumeField
                  ...
                  onChange={(e) =>
                    handleFieldChange(null, "resumeTitle", e.target.value, null)
                  }
                />
                    ...
                    <div className={style.layoutBox}>
                      <div className={style.box}>
                        <select
                          ...
                          onChange={(e) => {
                            const month =
                              resumeData.education[0].admissionDate.split("-")[1] || "01";
                            handleFieldChange(
                              0,
                              "admissionDate",
                      ...
                      <div className={style.box}>
                        <select
                          ...
                          onChange={(e) => {
                            const year =
                              resumeData.education[0].admissionDate.split("-")[0] || "";
                            handleFieldChange(
                              0,
                              "admissionDate",
                              `${year}-${e.target.value}`,
                    ...
                    <div className={style.layoutBox}>
                      <div className={style.box}>
                        <select
                          ...
                          onChange={(e) => {
                            const month =
                              resumeData.education[0].graduationDate.split("-")[1] || "01";
                            handleFieldChange(
                              0,
                              "graduationDate",
                              `${e.target.value}-${month}`,
                      ...
                      <div className={style.box}>
                        <select
                          ...
                          onChange={(e) => {
                            const year =
                              resumeData.education[0].graduationDate.split("-")[0] || "";
                            handleFieldChange(
                              0,
                              "graduationDate",
                              `${year}-${e.target.value}`,
